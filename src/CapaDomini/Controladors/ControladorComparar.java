    ...
    public DTOComparar executar() throws CaracterNoASCII, ExtensionIncorrecta, IOException, VersionPPMIncorrecta, DatosIncorrectos {
        ...
        switch (algoritmo) {
            ...
            case 2: {
                ...
                if (pathGuardar != ".notvalid.") {
                    io.guardaArxiuTXT(pathGuardar,descomprimit.getContingut());
                }
                break;
            }
            case 3: {
            ...
            case 4: {
                byte[] cont = io.llegeixArxiuBinari(pathLlegir, ".txt");
                contingutInicial = cont;
                ArxiuBytes arxiuNormal = new ArxiuBytes(pathLlegir,cont);
