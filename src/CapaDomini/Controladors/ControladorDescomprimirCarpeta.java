...
public class ControladorDescomprimirCarpeta {
        ...
        if (fi.length()> 0) {
            ...
            for (ArxCarpetaComp acc: arxius) {
                ...
                if (path.contains(".jimg")) {
                    ...
                    resultat = d;
                    guardaEstadisticas("LZW",resultat);
                }
                    ...
                    resultat = d;
                    guardaEstadisticas("LZSS",resultat);
                    ...
                    resultat = d;
                    guardaEstadisticas("LZ78",resultat);
    ...
    private void crearDirectoriosPadres(String path_file, boolean carpeta) {
        ...
        while (!f_act.exists()) {
            ...
            while(path_file.charAt(tamany_path_intern) != '/' && path_file.charAt(tamany_path_intern) != '\\'){
                --tamany_path_intern;
            }
